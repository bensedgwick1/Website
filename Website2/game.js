...
const passages = {
  ...
  "Forest": {
    ...
    options: [
      ...
      { text: "Climb a tall tree", target: "TreeTopView" },
  ...
  "TreeTopView": {
    title: "Treetop View",
    image: "https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=800&q=80",
    text: "You climb a tall, sturdy tree, and from the top, you can see over the forest. In the distance, you spot a crumbling stone structure, clearly ancient ruins.",
    options: [
      { text: "Climb down and head for the ruins", target: "AncientRuins" },
      { text: "Climb down and return to the forest floor", target: "Forest" }
    ],
    effects: { energy: -10 }
  },
  "AncientRuins": {
    ...
    text: "You arrive at the ancient ruins. The stones are covered in moss, and the air is thick with the smell of damp earth. There are two paths ahead.",
    options: [
        { text: "Explore the left path", target: "RuinsLeft" },
        { text: "Explore the right path", target: "RuinsRight" }
    ]
  },
  "RuinsLeft": {
    title: "Ruins - Left Path",
    image: "https://images.unsplash.com/photo-1555949963-ff9fe0c870eb?auto=format&fit=crop&w=800&q=80",
    text: "The left path leads to a dead end. You find nothing of interest.",
    options: [
        { text: "Go back", target: "AncientRuins" }
    ]
  },
  "RuinsRight": {
    title: "Ruins - Right Path",
    image: "https://images.unsplash.com/photo-1555949963-ff9fe0c870eb?auto=format&fit=crop&w=800&q=80",
    text: "The right path leads to a small, hidden chest. You find a health potion inside.",
    item: "Health Potion",
    options: [
        { text: "Go back", target: "AncientRuins" }
    ]
